 ...
 */
    ...
    function distributeHoldings(uint256 amount) private {
        ...
        if (
            totalDistributed + amount > revenueTiers[currentTier].limitAmount ||
            revenueTiers[currentTier].limitAmount > 0
        ) {
